                ...
                <div className='services_div'>
                    ...
                    <div className={!openn ? 'service_link_div' : '.service_link_div2'}>
                            ...
                            <li>
                                ...
                                <p>
                                    On Demand Delivery solution 
                                        ...
                                        <li>
                                            <Link to="/" className='link'>Lozpdata Chain</Link>
                                            <p>Blockchain Solution</p>
                                        </li>
                                        <li>
                                            <Link to="/" className='link'>Lozpdata Insight Machine'</Link>
                        ...
                        <ul className='service_ul2'>
                            ...
                            <li>
                                <Link to="/" className='link'>Lozpdata Hero</Link>
                                <p>Powerfull RPG Solution</p>
                            </li>
                            <li>
                                <Link to="/" className='link'>Messenger</Link>
                                <p>Real-time messaging solution</p>
                            </li>
                            <li>
                                <Link to="/" className='link'>Chat Bot</Link>
                                <p>Smart Chatbot solution</p>
                            </li>
                            <li>
                                <Link to="/" className='link'>Social Platform</Link>
                                <p>Social-App building Platform</p>
                            </li>
                            <li>
                                <Link to="/" className='link'>Events Management</Link>
